    ...
    <div class="content__head">
      <div class="container">
        <div class="row">
          <div class="col-12">
            <!-- content title -->
            <h2 class="content__title">Generos</h2>
            <!-- end content title -->
            <?php
        ...
        <div class="row">
          ...
          <?php if (mysqli_num_rows($resultado) != 0) {
            while ($fila = mysqli_fetch_array($resultado)) { ?>
              ...
              <article id="<?php echo $fila['id']; ?>" class="<?php echo $clasesGenero; ?>" class="col-6 col-sm-4 col-lg-3 col-xl-2">
                ...
                <div class=" card">
                  ...
                  <div class="card__content">
                    ...
                    <span class="card__category">
                      <p style="color:white">Generos : <?php echo $textoGenero; ?></p>
                    </span>
