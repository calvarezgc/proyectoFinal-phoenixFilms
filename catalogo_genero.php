...
<head>
  ...
  $headKeywords .= "generos, catálogo, película";
  ?>
  <style>
    .nav-tabs {
  ...
  <section class="content">
    ...
    <script>
      function peliculasFiltarGenero(genero) {
        ...
        // var columnsA = document.getElementsByClassName("col-6 col-sm-4 col-lg-3 col-xl-2");
        for (i = 0; i < articulos.length; i++) {
          articulos[i].style.display = "none";
          //columnsA[i].classList.remove("col-6 col-sm-4 col-lg-3 col-xl-2");
        }
        articulosver = document.querySelectorAll(miclase);
        for (i = 0; i < articulosver.length; i++) {
          articulosver[i].style.display = "block";
          //columnsA[i].classList.add("col-6 col-sm-4 col-lg-3 col-xl-2");
        }
      }
    </script>
