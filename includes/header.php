          ...
          <div class="header__content">
            ...
            <div class="header__auth">
              ...
              if (isset($_SESSION['usuario'])) { ?>
                <!-- dropdown -->
                <li class="header__nav-item">
                  <a class="header__sign-in dropdown-toggle " href="#" role="button" id="dropdownMenuPerfil" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo $_SESSION['nombre']; ?></a>

                  <ul class="dropdown-menu header__dropdown-menu" aria-labelledby="dropdownMenuPerfil">
                    <li><a href="usuario_modificacion.php?id=<?php echo $_SESSION['usuarioid']; ?> ">Editar</a></li>
